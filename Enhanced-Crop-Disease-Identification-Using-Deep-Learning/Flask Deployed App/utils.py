disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/> <br>Fertilizer and Pesticides:<br>
        
        <br/>Nitrogenous Fertilizers: Urea, Calcium Ammonium Nitrate, Ammonium Sulphate
        <br>Insecticides: Imidacloprid, Lambda-cyhalothrin, Permethrin
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        ...
        <br/>5. Be sure to remove the stumps of any apple trees you cut down. Dead stumps can be a source of spores. <br/> <br>Fertilizer and Pesticides:<br>
        
        <br/>Phosphorus Fertilizers: Single Super Phosphate, Triple Super Phosphate, Monoammonium Phosphate, Di-ammonium Phosphate
        <br>Herbicides: Atrazine, Paraquat, Gramoxone
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        ...
        <br/>Potassium Fertilizers: Muriate of Potash, Potassium Chloride, Potassium Sulfate
        <br>Herbicides: Atrazine, Paraquat, Gramoxone
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        ...
        <br/>N-P-K Fertilizers: N.P.K, N.P.(Complex)
        <br>Herbicides: Atrazine, Paraquat, Gramoxone
<br>Fungicides: Chlorothalonil
    ...
    'Grape___Black_rot': """ <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        ...
        <br/><br/><br/>Fertilizer:
        <br/>Urea: A common nitrogen fertilizer that can be used as a base, topdressing, or seed fertilizer
<br/>Ammonium sulfate: A nitrogen-based fertilizer
<br/>Ammonium chloride: A nitrogen-based fertilizer
<br/>Calcium ammonium nitrate: A top-dressing fertilizer that contains 26% nitrogen
